...
Карточки анализируемых компаний. Каждая компания — папка с файлами:
- `_index.md` — наше исследование
- `opinions.md` — внешние мнения (автогенерация)
...
| Тикер | Компания | Sentiment | Position | Мнений |
|-------|----------|-----------|----------|--------|
| [YNDX](YNDX/) | Яндекс | | watch | 4 |
| [YDEX](YDEX/) | Яндекс (новый) | | watch | 4 |
...
| Тикер | Компания | Sentiment | Position | Мнений |
|-------|----------|-----------|----------|--------|
| [PHOR](PHOR/) | ФосАгро | bullish | buy | 6 |
| [AKRN](AKRN/) | Акрон | | watch | 6 |

### Энергетика
| Тикер | Компания | Sentiment | Position | Мнений |
|-------|----------|-----------|----------|--------|
| [IRAO](IRAO/) | Интер РАО | | watch | 1 |
| [HYDR](HYDR/) | РусГидро | | watch | 1 |

### Строительство
| Тикер | Компания | Sentiment | Position | Мнений |
|-------|----------|-----------|----------|--------|
| [PIKK](PIKK/) | ПИК | | watch | 6 |
...
|-------|----------|---------|
| POSI | Positive Technologies | 65 упоминаний в @investopit |
| TCSG | Т-Банк | 19 упоминаний, активный анализ |
| SBER | Сбербанк | 16 упоминаний |
| GAZP | Газпром | 14 упоминаний |

## Топ-идеи

| Тикер | Тезис | Источник |
|-------|-------|----------|
| GMKN | +30% рост, ожидается подорожание металлов | @investopit |
