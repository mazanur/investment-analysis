...
- [ ] Фаза 0: создать папку из шаблона `_TEMPLATE`, скопировать чеклист
- [ ] Фаза 1: прочитать контекст (sectors/oil-gas, russia/macro, russia/regulations)
- [ ] Фаза 2: собрать финансовые данные (МСФО годовые + квартальные)
- [ ] Фаза 3: описать бизнес-модель (нефтедобыча, переработка, шинный бизнес)
- [ ] Фаза 4: оценить финансовое здоровье (red/green flags, stop-conditions)
- [ ] Фаза 5: рассчитать справедливую стоимость (P/E или EV/EBITDA, 3 сценария)
- [ ] Фаза 6: определить позицию (buy/watch/hold/sell) и sentiment
- [ ] Фаза 7: заполнить _index.md по стандарту, обновить корневой _index.md
- [ ] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [ ] Сгенерировать trend.json через `python3 scripts/generate_trend_json.py`
...
- [ ] Фаза 0: скопировать чеклист (папка уже существует)
- [ ] Фаза 1: прочитать контекст (sectors/metals-mining, russia/macro, russia/regulations — санкции!)
- [ ] Фаза 2: собрать финансовые данные
- [ ] Фаза 3: описать бизнес-модель (алюминий, глинозём, зависимость от Норникеля)
- [ ] Фаза 4: оценить финансовое здоровье (особое внимание: долг, санкции)
- [ ] Фаза 5: рассчитать справедливую стоимость
- [ ] Фаза 6: определить позицию и sentiment
