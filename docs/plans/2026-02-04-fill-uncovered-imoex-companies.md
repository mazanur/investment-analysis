...
- [x] Фаза 0: создать папку из шаблона, скопировать чеклист
- [x] Фазы 1-6: полное исследование (авиаперевозки, санкции на авиапарк, лизинг, гос.поддержка)
- [x] Фаза 7: заполнить _index.md, обновить корневой _index.md
- [x] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [x] Сгенерировать trend.json
- [x] Закоммитить и запушить
...
- [x] Фаза 0: создать папку из шаблона, скопировать чеклист
- [x] Фазы 1-6: полное исследование (ипотечное кредитование, гос.институт развития, облигации)
- [x] Фаза 7: заполнить _index.md, обновить корневой _index.md
- [x] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [x] Сгенерировать trend.json
- [x] Закоммитить и запушить
...
- [x] Фаза 0: создать папку из шаблона, скопировать чеклист
- [x] Фазы 1-6: полное исследование (монополия на нефтепроводы, тарифное регулирование, дивиденды прив.)
- [x] Фаза 7: заполнить _index.md, обновить корневой _index.md
- [x] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [x] Сгенерировать trend.json
- [x] Закоммитить и запушить
...
- [x] Фаза 0: создать папку из шаблона, скопировать чеклист
- [x] Фазы 1-6: полное исследование (универсальный банк, корпоративное кредитование, NIM, ROE)
- [x] Фаза 7: заполнить _index.md, обновить корневой _index.md
- [x] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [x] Сгенерировать trend.json
- [x] Закоммитить и запушить
...
- [x] Фаза 0: создать папку из шаблона, скопировать чеклист
- [x] Фазы 1-6: полное исследование (энергетика + доля в РУСАЛ, ГЭС, санкции Дерипаска)
- [x] Фаза 7: заполнить _index.md, обновить корневой _index.md
- [x] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [x] Сгенерировать trend.json
- [x] Закоммитить и запушить
...
- [x] Фаза 0: создать папку из шаблона, скопировать чеклист
- [x] Фазы 1-6: полное исследование (холдинг: МТС, Segezha, Ozon, Медси, Степь; долг, IPO дочек)
- [x] Фаза 7: заполнить _index.md, обновить корневой _index.md
- [x] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [x] Сгенерировать trend.json
- [x] Закоммитить и запушить
...
- [x] Фаза 0: создать папку из шаблона, скопировать чеклист
- [x] Фазы 1-6: полное исследование (золотодобыча, себестоимость, AISC, цены на золото)
- [x] Фаза 7: заполнить _index.md, обновить корневой _index.md
- [x] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [x] Сгенерировать trend.json
- [x] Закоммитить и запушить
...
- [x] Фаза 0: создать папку из шаблона, скопировать чеклист
- [x] Фазы 1-6: полное исследование (онлайн-классифайд, рынок недвижимости, конкуренция с Авито/ДомКлик)
- [x] Фаза 7: заполнить _index.md, обновить корневой _index.md
- [x] Фаза 8: финальная проверка, удалить RESEARCH_CHECKLIST.md
- [x] Сгенерировать trend.json
- [x] Закоммитить и запушить
