...
- [x] README.md для investment-api: setup, API docs (ссылка на /docs), deployment
- [x] Обновить CLAUDE.md в investment-analysis: описать API-интеграцию и sync_analysis.py
- [x] Обновить Makefile в investment-analysis: добавить target `sync` для вызова sync_analysis.py
