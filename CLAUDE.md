...
2. Проверь `companies/{TICKER}/opinions.md` — есть ли внешние мнения
3. Загрузи данные со smart-lab (годовые + квартальные МСФО)
4. Пойми бизнес-модель, оцени финансовое здоровье
5. Рассчитай справедливую цену несколькими методами
6. Определи upside, сформулируй тезис и position
7. Заполни `companies/{TICKER}/_index.md`, обнови `_index.md` и таблицу компаний в секторе
